...
export const getModeratorOffers = data =>
  http.post('offers/moderator-list', data);
export const approveOffer = data => http.post('offers/approve', data);
export const rejectOffer = data => http.post('offers/reject', data);
